...
const techOriented = () => (
  <Layout>
    ...
    <div className="post">
      ...
      <p className="post__summary tech">
      ...
      <div className="post__ordered-list">
        <li>1) To be in tune with our technological world</li>
        <p>
        ...
        <li>2) Being able to create software</li>
        <p>
