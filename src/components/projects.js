    ...
    <div className="squares-container">
      <div className="square n1">
        <div className="square__content">
          ...
          <p className="square__text">
            Social network similar to 9GAG with CRUD functions and cookies based
            authentification. Users signup and login before posting GIFs and
            commenting on posts.
          </p>
      ...
      <div className="square n3">
        <div className="square__content">
          ...
          <p className="square__text">
            A website designed to help me manage my daily life. It includes
            weekly and yearly goals, financial metrics and more. LocalStorage is
            used to save checkboxes' values, dark mode preferences and savings
            data.
          </p>
          <ul className="square__list">
            <div className="square__list-item">
